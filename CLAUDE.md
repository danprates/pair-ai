...
- `tmp/` is gitignored; it holds the user-project output of the skills (`diff.txt`, `code-review.md`, `pull-request.md`, `handoff.md`, `explain.md`, `guide.md`, `verify.md`) and task suites (`tasks/<suite-id>/000-orchestrator.md`, `001–NNN` implementation tasks, `999-validate.md`); it is also the location users use to override templates (`tmp/templates/<skill>.md` and `tmp/templates/create-task-<variant>.md`).
